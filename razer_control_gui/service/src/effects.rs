...
impl BreathEffect {
    pub fn new(red: u8, green: u8, blue: u8, cycle_duration_ms: u32) -> BreathEffect {
        ...
        return BreathEffect {
            ...
            curr_step: 0,
            target_colour : rgb::AnimatorKeyColour { red: red as f32, green: green as f32, blue: blue as f32 },
            current_colour : rgb::AnimatorKeyColour { red: 0.0, green: 0.0, blue: 0.0 },
            animator_step_colour : rgb::AnimatorKeyColour {
                red: red as f32 / (cycle_duration_ms as f32 / ANIMATIONS_DELAY_MS as f32) as f32,
                green: green as f32 / (cycle_duration_ms as f32 / ANIMATIONS_DELAY_MS as f32) as f32,
...
impl Effect for BreathEffect {
    fn update(&mut self) -> rgb::KeyboardData {
        match self.curr_step {
            0 => {
                self.current_colour = rgb::AnimatorKeyColour { red: 0.0, green: 0.0, blue: 0.0 };
            ...
            3 => { // Decreasing
                self.current_colour -= self.animator_step_colour;
                let target = rgb::AnimatorKeyColour { red: 0.0, green: 0.0, blue: 0.0 };
